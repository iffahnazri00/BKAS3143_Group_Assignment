...
<input type="text" class="form-control" name="cust_email" placeholder="Enter Your Email">
...
$sel_c = "select * from customers where cust_email='$cust_email'";
